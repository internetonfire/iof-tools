...
ip netns exec ns5 ip address add 10.0.0.6/30 dev tap5
ip netns exec ns5 ip address add 10.0.0.10/30 dev tap5
ip netns exec ns5 ip address add 10.0.0.22/30 dev tap5

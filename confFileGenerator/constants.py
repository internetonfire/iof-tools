...
ARGS = ['graph=', 'out=', 'directories', 'help', 'h', 'nomrai', 'mraitype=', 'prepath=', 'ipnetworksgraph=',
        'noautomaticnetworks', 'doublepeering', 'fatallog', 'prefevaluator=', 'mraijitter=']
...
HELP_MESSAGE = """
I wrote a README.md for a reason
Have a nice day :)
"""
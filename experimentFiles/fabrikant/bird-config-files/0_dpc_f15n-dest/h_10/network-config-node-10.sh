...
ip netns exec ns10 ip address add 10.0.0.58/30 dev tap10
ip netns exec ns10 ip address add 10.0.0.61/30 dev tap10
ip netns exec ns10 ip address add 10.0.0.65/30 dev tap10

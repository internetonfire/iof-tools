...
ip netns exec ns14 ip address add 10.0.0.82/30 dev tap14
ip netns exec ns14 ip address add 10.0.0.85/30 dev tap14
ip netns exec ns14 ip address add 10.0.0.89/30 dev tap14

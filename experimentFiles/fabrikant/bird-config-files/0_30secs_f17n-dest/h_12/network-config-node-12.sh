...
ip netns exec ns12 ip address add 10.0.0.70/30 dev tap12
ip netns exec ns12 ip address add 10.0.0.73/30 dev tap12
ip netns exec ns12 ip address add 10.0.0.77/30 dev tap12

...
ip netns exec ns4 ip address add 10.0.0.18/30 dev tap4
ip netns exec ns4 ip address add 10.0.0.22/30 dev tap4
ip netns exec ns4 ip address add 10.0.0.25/30 dev tap4
ip netns exec ns4 ip address add 10.0.0.29/30 dev tap4
